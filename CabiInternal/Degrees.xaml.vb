...
Public Class Degrees
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        bm.ExcuteNonQuery("UpdateDoctorPrices", {"Id"}, {Val(txtID.Text)})
    ...
    Sub DeleteDetails()
        bm.ExcuteNonQuery("delete from " & TableDetailsName & " where DegreeId='" & txtID.Text.Trim & "'")
    ...
    Private Sub FillGrid()
        dt = bm.ExcuteAdapter("GetVisitingTypeDegrees", {"DegreeId"}, {Val(txtID.Text)})
        G.Rows.Clear()
