...
Public Class Entry2
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.control = New Control() {txtFlag, txtID, DayDate, Value, Value1, MainAccNo1, SubAccNo1, CurrencyId1, Value2, MainAccNo2, SubAccNo2, CurrencyId2, Notes, Canceled, CostTypeId, PurchaseAccNo, ImportMessageId, StoreId, StoreInvoiceNo, IsCost1, IsCost2}
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If bm.ShowDeleteMSG() Then
            bm.ExcuteNonQuery("delete from " & TableName & " where " & SubId & "='" & txtFlag.Text.Trim & "' and " & SubId2 & "=" & txtID.Text)
            btnNew_Click(sender, e)
        End If
    End Sub
    ...
    Private Sub SubAccNo1_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles SubAccNo1.LostFocus
        ...
        dt = bm.ExcuteAdapter("select * from LinkFile where Id=(select C.LinkFile from Chart C where C.Id='" & MainAccNo1.Text & "')")
    ...
    Private Sub MainAccNo1_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MainAccNo1.LostFocus
        ...
        SubAccNo1.IsEnabled = bm.ExcuteAdapter("select * from LinkFile where Id=(select C.LinkFile from Chart C where C.Id='" & MainAccNo1.Text & "')").Rows.Count > 0
        SubAccNo1_LostFocus(Nothing, Nothing)
    ...
    Private Sub SubAccNo2_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles SubAccNo2.LostFocus
        ...
        dt = bm.ExcuteAdapter("select * from LinkFile where Id=(select C.LinkFile from Chart C where C.Id='" & MainAccNo2.Text & "')")
    ...
    Private Sub MainAccNo2_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MainAccNo2.LostFocus
        ...
        SubAccNo2.IsEnabled = bm.ExcuteAdapter("select * from LinkFile where Id=(select C.LinkFile from Chart C where C.Id='" & MainAccNo2.Text & "')").Rows.Count > 0
        SubAccNo2_LostFocus(Nothing, Nothing)
    ...
    Private Sub LoadResource()
        ...
        lblMainAccNo1.SetResourceReference(Label.ContentProperty, "MainAccNo")
        lblSubAccNo1.SetResourceReference(Label.ContentProperty, "SubAccNo")
        lblMainAccNo2.SetResourceReference(Label.ContentProperty, "MainAccNo")
        lblSubAccNo2.SetResourceReference(Label.ContentProperty, "SubAccNo")
    End Sub
    ...
    Private Sub btnPrint_Click(sender As Object, e As RoutedEventArgs) Handles btnPrint.Click
        ...
        rpt.paravalue = New String() {Val(txtFlag.Text), Val(txtID.Text), CType(Parent, Page).Title}
        rpt.Show()
    End Sub
