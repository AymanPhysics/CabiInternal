...
Public Class LeaveRequests2
    ...
    Private Sub EmpId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles EmpId.LostFocus
        ...
        Dim dt As DataTable = bm.ExcuteAdapter("select Annual,NoofDaysOff,dbo.GetEmpLeaveBal2(Id,1) AnnualUsed,dbo.GetEmpLeaveBal2(Id,2) DayOffUsed from Employees where Id=" & EmpId.Text.Trim())
        If dt.Rows.Count > 0 Then
