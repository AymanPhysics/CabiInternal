...
Public Class Employees
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, "Name", "Address", "DateOfBirth", "DepartmentId", "Deliveryman", "Notes", "Nurse", "Receptionist", "Manager", "SystemUser", "NationalId", "HomePhone", "Mobile", "Email", "Password", "EnName", "LevelId", "Stopped", "HiringDate", "hh", "hh2", "hh3", "hh4", "hh5", "hh6", "hh7", "mm", "mm2", "mm3", "mm4", "mm5", "mm6", "mm7", "Saturday", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "IsSalary", "IsFreelancer", "LateAllowance", "Allowance", "SpAllowance", "FromHH", "ToHH", "FromMM", "ToMM", "Salary", "SalaryOnly", "ShiftsOnly", "SalaryOrShifts", "ShiftCount", "ShiftValue", "Tax", "Bonus", "Insurance", "Annual", "NoofDaysOff", "NoofMonthlyExecuses", "HolidayWorkValue", "DelayValue", "OvertimeValue", "IsFixedHours", "TotalHours", "TotalMinutes", "HasAttendance", "MainJobId", "SubJobId", "TaxAccNo", "DefaultStore", "DefaultSave", "Waiter", "DefaultBank", "FromHHTemp", "FromMMTemp", "ToHHTemp", "ToMMTemp", "TotalHoursTemp", "TotalMinutesTemp", "FromDate", "ToDate", "EditPrices", "DegreeId", "GraduationYear", "NoLicenseToPractice", "CategoryId", "CarId", "LeaveDate", "LawsNotApplicable", "IsShiftRotation", "ShiftRotationDayDate"}
        bm.control = New Control() {txtID, ArName, Address, DateOfBirth, DepartmentId, Deliveryman, Notes, Nurse, Receptionist, Manager, SystemUser, NationalId, HomePhone, Mobile, Email, Password, EnName, LevelId, Stopped, HiringDate, hh, hh2, hh3, hh4, hh5, hh6, hh7, mm, mm2, mm3, mm4, mm5, mm6, mm7, Saturday, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, IsSalary, IsFreelancer, LateAllowance, Allowance, SpAllowance, FromHH, ToHH, FromMM, ToMM, Salary, SalaryOnly, ShiftsOnly, SalaryOrShifts, ShiftCount, ShiftValue, Tax, Bonus, Insurance, Annual, NoofDaysOff, NoofMonthlyExecuses, HolidayWorkValue, DelayValue, OvertimeValue, IsFixedHours, TotalHours, TotalMinutes, HasAttendance, MainJobId, SubJobId, TaxAccNo, StoreId, SaveId, Waiter, BankId, FromHHTemp, FromMMTemp, ToHHTemp, ToMMTemp, TotalHoursTemp, TotalMinutesTemp, FromDate, ToDate, EditPrices, DegreeId, GraduationYear, NoLicenseToPractice, CategoryId, CarId, LeaveDate, LawsNotApplicable, IsShiftRotation, ShiftRotationDayDate}
        bm.KeyFields = New String() {SubId}
        bm.Table_Name = TableName
        btnNew_Click(sender, e)
        IsSalary_Checked(Nothing, Nothing)
        IsFixedHours_Unchecked(Nothing, Nothing)
        IsShiftRotation_UnChecked(Nothing, Nothing)

        If Md.UserName <> 1 Then
            lblLevelId.Visibility = Windows.Visibility.Hidden
            LevelId.Visibility = Windows.Visibility.Hidden
            LevelName.Visibility = Windows.Visibility.Hidden
        End If

        lblhh.Visibility = Windows.Visibility.Hidden
        hh.Visibility = Windows.Visibility.Hidden
        hh2.Visibility = Windows.Visibility.Hidden
        hh3.Visibility = Windows.Visibility.Hidden
        hh4.Visibility = Windows.Visibility.Hidden
        hh5.Visibility = Windows.Visibility.Hidden
        hh6.Visibility = Windows.Visibility.Hidden
        hh7.Visibility = Windows.Visibility.Hidden
        lblmm.Visibility = Windows.Visibility.Hidden
        mm.Visibility = Windows.Visibility.Hidden
        mm2.Visibility = Windows.Visibility.Hidden
        mm3.Visibility = Windows.Visibility.Hidden
        mm4.Visibility = Windows.Visibility.Hidden
        mm5.Visibility = Windows.Visibility.Hidden
        mm6.Visibility = Windows.Visibility.Hidden
        mm7.Visibility = Windows.Visibility.Hidden
    ...
    Sub ClearControls()
        ...
        HolidayWorkValue.Text = 1
        FromHH.Text = 8
        ToHH.Text = 17
        CalcTotalHoursMinutes()
        IsSalary.IsChecked = True
        SalaryOnly.IsChecked = True
        HasAttendance.IsChecked = True
    ...
    Private Sub LoadResource()
        ...
        Deliveryman.SetResourceReference(CheckBox.ContentProperty, "Deliveryman")
        ...
        LawsNotApplicable.SetResourceReference(Label.ContentProperty, "LawsNotApplicable")
        ...
        lblLeaveDate.SetResourceReference(Label.ContentProperty, "LeaveDate")
    ...
    Private Sub Deliveryman_Checked(sender As Object, e As RoutedEventArgs) Handles Deliveryman.Checked
        CategoryId.Visibility = Windows.Visibility.Visible
        CarId.Visibility = Windows.Visibility.Visible
    End Sub

    Private Sub Deliveryman_UnChecked(sender As Object, e As RoutedEventArgs) Handles Deliveryman.Unchecked
    ...
    Private Sub CategoryId_LostFocus(sender As Object, e As RoutedEventArgs) Handles CategoryId.LostFocus
        bm.FillCombo("select Id,Name From Cars where CategoryId=" & Val(CategoryId.SelectedValue) & " union select 0 Id,'-' Name", CarId)
    End Sub

    Private Sub IsShiftRotation_Checked(sender As Object, e As RoutedEventArgs) Handles IsShiftRotation.Checked
        ShiftRotationDayDate.Visibility = Windows.Visibility.Visible
    End Sub

    Private Sub IsShiftRotation_UnChecked(sender As Object, e As RoutedEventArgs) Handles IsShiftRotation.Unchecked
        ShiftRotationDayDate.Visibility = Windows.Visibility.Hidden
    End Sub
