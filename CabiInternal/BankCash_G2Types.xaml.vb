...
Public Class BankCash_G2Types
    ...
    Sub FillControls()
        bm.FillControls()
        Dim dt As DataTable = bm.ExcuteAdapter("select *,dbo.GetEmpArName(EmpId)EmpName from " & TableDetailsName & " where TypeId" & "=" & txtID.Text.Trim & " and Flag=" & txtFlag.Text)
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If bm.ShowDeleteMSG("MsgDelete") Then
            bm.ExcuteNonQuery("delete from " & TableName & " where " & SubId & "='" & txtFlag.Text.Trim & "' and " & SubId2 & "='" & txtID.Text.Trim & "'    delete from " & TableDetailsName & " where " & SubId & "='" & txtFlag.Text.Trim & "' and " & "TypeId" & "='" & txtID.Text.Trim & "'")
            btnNew_Click(sender, e)
        End If
    End Sub
