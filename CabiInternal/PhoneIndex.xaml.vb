...
Public Class PhoneIndex
    ...
    Private Sub Window_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        LoadResource()
        Try
            dt = bm.ExcuteAdapter("select Phone1,Phone2,Phone3,Name,Id from PhoneIndex")
            dt.TableName = "tbl"
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnSave.Click
        ...
        If Not bm.ExcuteNonQuery("Insert PhoneIndex(Phone1,Phone2,Phone3,Name) select '" & txtIDx.Text.Replace("'", "''") & "','" & txtID2x.Text.Replace("'", "''") & "','" & txtID3x.Text.Replace("'", "''") & "','" & txtNamex.Text.Replace("'", "''") & "'") Then Return
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnDelete.Click
        ...
        bm.ExcuteNonQuery("Delete PhoneIndex where Id=" & DataGridView1.Items(DataGridView1.SelectedIndex)(4))
        btnNew_Click(Nothing, Nothing)
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button1.Click
        ...
        If Not bm.ExcuteNonQuery("Update PhoneIndex set Phone1='" & txtIDx.Text.Replace("'", "''") & "',Phone2='" & txtID2x.Text.Replace("'", "''") & "',Phone3='" & txtID3x.Text.Replace("'", "''") & "',Name='" & txtNamex.Text.Replace("'", "''") & "' where Id=" & DataGridView1.Items(i)(4)) Then Return
