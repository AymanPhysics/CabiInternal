...
Public Class Customers
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        LoadResource()
        bm.Fields = New String() {SubId, SubName, "AccNo", "CountryId", "CityId", "AreaId", "Address", "Floor", "Appartment", "Tel", "Mobile", "CurrencyId", "Exchange", "MainBal0", "Bal0", "DescPerc", "Type", "ApplyCurrencyCycle"}
        bm.control = New Control() {txtID, txtName, AccNo, CountryId, CityId, AreaId, Address, Floor, Appartment, Tel, Mobile, CurrencyId, Exchange, MainBal0, Bal0, DescPerc, Type, ApplyCurrencyCycle}
