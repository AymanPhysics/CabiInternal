...
Public Class RPT11
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = New String() {"@MainAccNo", "MainAccName", "@DayDate", "@ToDate", "@LinkFile", "Header"}
        rpt.paravalue = New String() {MainAccNo.Text, MainAccName.Text, ToDate.SelectedDate, ToDate.SelectedDate, MyLinkFile, CType(Parent, Page).Title.Trim & " " & MainLinkFile.Text}
        Select Case Flag
            Case 1
